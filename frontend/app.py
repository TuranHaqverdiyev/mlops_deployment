...
def detect_mime(filename: str) -> str:
    ...
    if name.endswith(".parquet"):
        return "application/octet-stream"  # Parquet doesn't have a standard browser MIME
...
def main():
    ...
    # Main header
    st.markdown(
        '<h1 class="main-header"> Multisim User Predictor</h1>',
        unsafe_allow_html=True,
    )
    st.markdown(
